                ...
                <div class="carousel-item active">
                    ...
                    <div class="row">
                        ...
                        <div class="detail_box">
                            ...
                            <a href="#" class="btn-2" onclick="event.preventDefault(); ">
                                saber mas
                            </a>
                            </div>
                        </div>
    ...
    <section class="portfolio_section layout_padding">
        ...
        <div class="card-deck">
            ...
            <div class="card-footer">
                <button type="button" class="btn btn-outline-primary a_hover" onclick="location.href='{{ url('/usuario/italia') }}'">
                    comprar viajes a Italia
                </button>
            </div>
            </div>
            <div class="card">
            ...
            <div class="card-footer">
                <button type="button" class="btn btn-outline-primary a_hover" onclick="location.href='{{ url('/usuario/tinum') }}'">
                    comprar viajes a Tinum
                </button>
            </div>
            </div>
            <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">sumérgete en la cuna de la civilización occidental.</p>
            </div>
            <div class="card-footer">
                <button type="button" class="btn btn-outline-primary a_hover" onclick="location.href='{{ url('/usuario/grecia') }}'">
                    comprar viajes a Grecia
                </button>
            </div>
            </div>
        </div>
        <div class="see_btn">
            <a href="#" onclick="event.preventDefault(); ">VER MAS</a>
        </div>
        </div>
    </section>
